...
6. Deploy PM:
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm ecommerce-app -p /Users/username/projects/ecommerce-app
```
...
6. Deploy:
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm api-backend -p /Users/username/work/api-backend
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm ui-components -p /Users/username/projects/ui-components
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm django-blog -p /Users/username/work/django-blog
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm company-monorepo -p /Users/username/work/company-monorepo
```
...
python3 ${CLAUDE_PLUGIN_ROOT}/lib/orchestrator.py deploy-pm old-dashboard -p /Users/username/projects/old-dashboard
```
